...
epochs_list = [100]  #[2000]
lr_list = [1e-5,5e-6]   # removed on account of not as good:   2.5e-4, 5e-5,
hidden_layer_list = [5] #[2,4,5] #[1,2,3,4]
optimizer_list = ['adam']#,'sgd']
dropout_list = [0.1,0.25]   #  0.0,

log_dir_list = [1]   # gme_new
sample_size_list = [128]#,128]
batch_size_list =  [64] #[4,64]   # 16,
soft_train_list = [1]
allow_unfairness_gap_list = [  (1,0.225), (1,0.25), (1,0.275), (1,0.3), (1,0.325), (1,0.350), (1,0.375) ]  #[ (0,0.0), (1,0.0), (1,0.025), (1,0.05), (1,0.075), (1,0.1), (1,0.125), (1,0.150), (1,0.175), (1,0.2), (1,0.4) ]
#allow_unfairness_gap_list = [ (0,0.0), (1,0.0), (1,0.025), (1,0.05), (1,0.1), (1,0.2), (1,0.4), (1,0.8), (1,1.6) ]
#allow_unfairness_list = [0]
#fairness_gap_list = [0.0]
embed_groups_quadscore_list = [ (0,0)  ]#, (1,0) ]#, (0,1) ]        #  [(0,0)]
#embed_groups_list = [0]
#embed_quadscore_list = [0]
output_tag = 'spo_tests_' + str(date.today()) + '_'
